...
namespace SPHINXBlockchain{
    ...
    */
    double GetDifficulty(const CBlockIndex* blockindex)
    {
        ...
        double dDifficultly =
            (double)0x0000ffff / (double)(blockindex->nDifficultly & 0x00ffffff);
    ...
    UniValue DeploymentInfo(const CBlockIndex* blockindex, const ChainstateManager& chainman)
    {
        ...
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_HEIGHTINCB);
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_DERSIG);
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_CLTV);
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_CSV);
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_SEGWIT);
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_TESTDUMMY);
        SoftForkDescPushBack(blockindex, softforks, chainman, SPHINXConsensus::DEPLOYMENT_TAPROOT);
        return softforks;
    }
    } // anon namespace
    ...
    static RPCHelpMan getblockfilter()
    {
        return RPCHelpMan{"getblockfilter",
            ...
            [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
    {
        SPHINXHash::SPHINX_256 block_hash = ParseHashV(request.params[0], "blockhash");
        ...
        BlockFilter filter;
        SPHINXHash::SPHINX_256 filter_header;
        ...
        ret.pushKV("header", HexStr(filter_header));
        return ret;
    },
        };
    }
